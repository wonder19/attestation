...
class PaymentPage:
    ...
    def continue_button(self):
        try:
            return self.wait.until(
                EC.visibility_of_element_located(PaymentLocators.FORWARD)
            )
    ...
    def card_error_alert(self):
        try:
            return self.wait.until(
                EC.visibility_of_element_located(PaymentLocators.CARD_ERROR_ALERT)
            )
        except NoSuchElementException:
            return self.wait.until(
                EC.visibility_of_element_located(PaymentLocators.CARD_ERROR_ALERT)
    ...
    def card_payment_demo_alert(self):
        return self.wait.until(
            EC.visibility_of_element_located(PaymentLocators.CARD_PAYMENT_DEMO_ALERT)
        )
    ...
    def payment_request_link(self):
        return self.wait.until(
            EC.visibility_of_element_located(PaymentLocators.PAYMENT_REQUEST_LINK)
        )
    ...
    def payment_request_popup_close_button(self):
        return self.app.wd.find_element(
            *PaymentLocators.PAYMENT_REQUEST_POPUP_CLOSE_BUTTON
        )
