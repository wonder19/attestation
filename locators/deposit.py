...
class DepositLocators:
    ...
    OPEN_PENS_DEPOSIT_BUTTON = (
        By.XPATH,
        '//*[@id="table-deposit-rates"]/tbody/tr[6]/td[7]/a',
    )
    END_DATE_INPUT = (By.ID, "endDate")
    AMOUNT_INPUT = (By.ID, "amount")
    CURRENCY_EUR_INPUT = (
        By.XPATH,
        '//*[@id="deposit-rates"]/div[1]/div[1]/label[2]/input',
    )
    ...
    DEPOSIT_ALERT_SUCCESS = (By.XPATH, '//*[@class="alert alert-success"]')
