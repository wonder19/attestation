...
class TestPayments:
    ...
    def test_payment_between_wallets_with_empty_fields(self, login):
        ...
        assert login.payment_page.empty_fields_alert_label_get_text() == PaymentPageConstants.EMPTY_FIELD_ALERT
    ...
    def test_card_payment_without_recipient_card(self, login):
        ...
        login.payment_page.continue_button_click()
        assert login.payment_page.card_error_alert_get_text() == PaymentPageConstants.SAME_CARD_ALERT
    ...
    def test_card_payment(self, login):
        ...
        login.payment_page.card_payment_amount_set_text('456456')
        login.payment_page.continue_button_click()
        assert login.payment_page.card_payment_demo_alert_get_text() == PaymentPageConstants.CARD_PAYMENT_DEMO_ALERT
    ...
    def test_payment_request(self, login):
        ...
        assert login.payment_page.payment_success_alert_get_text() == PaymentPageConstants.PAYMENT_REQUEST_SUCCESS_ALERT
